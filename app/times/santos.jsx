...
const stadiumImages = [
  {
    uri: "https://www.vilabelmiro.net/content-wp/uploads/2018/08/vila-belmiro-e1534192925162.jpg",
  }, // Nilton Santos 1
  {
    uri: "https://www.estadios.net/wp-content/uploads/2019/04/estadio-vila-belmiro-inicial.jpg",
  },
  {
    uri: "https://itograss.com.br/media/upload/novidades/novidade/0825d913-92cd-48f7-8727-c9541e14f7f4.jpg",
  },
];
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.main}>
        ...
        <View style={styles.bannerDown}>
                      <Image
              source={{
                uri: "https://upload.wikimedia.org/wikipedia/commons/1/15/Santos_Logo.png",
              }}
        ...
        <View style={styles.infos}>
          <Text style={styles.teamTitle}>Santos</Text>
          ...
          <View style={styles.subtitles}>
            <Image
              source={{
                uri: "https://mwsprod.imgix.net/imgix/kits/3a1a2fa0-3875-414f-614c-044efd8cedf7/default/player-front-153ed16d-06d3-41fa-ac84-7e015792b235.png?auto=format&w=960&h=960&fit=fill",
              }}
              style={styles.logoImage}
            />
            <View style={styles.texts}>
              <Text style={styles.subtitleText}>“Nascer, viver e no Santos morrer </Text>
              <Text style={styles.subtitleText}>é um orgulho que nem todos podem ter”</Text>
            </View>
            <Image
              source={{
                uri: "https://images.mantosdofutebol.com.br/wp-content/uploads/2024/10/2024-santos.png",
              }}
              style={styles.logoImage}
            />
          </View>
